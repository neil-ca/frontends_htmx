...
public class NoDuplicateContactsByEmailValidator
    implements ConstraintValidator<NoDuplicateContactsByEmail,
    ...
    if (contactService.contactWithEmailExists(formData.getEmail())) {
      ...
      context
          .buildConstraintViolationWithTemplate(
              "There is already a contact with this email address")
